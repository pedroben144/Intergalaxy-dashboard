...
<div class="card text-center">
    ...
    <div class="card-body">
      ...
      <p class="card-text">A quantidade de horas de {{$employee->name}} no periodo da {{$employee->start}} é de {{$employee->hours}} horas</p>
      <form action="{{  route('employees.destroy', $employee->id) }}" method="POST">
        @csrf
        @method('DELETE')
        <button class="btn btn-dark">Apagar</button><br/><br/>
    </form>
